...
<@content for="title">Modificar Tipo de Problemas</@content>


<@form action="update" method="put" id="${ tproblemas.id }">
<div class="panel panel-success">
    <div class="panel-body">Modificar Tipo Problemas</div>
    <div class="panel-footer">
        <div class="form-group">
            <label class="col-sm-2 control-label" for="nombre">Nombre * : </label>
            <input class="form-control"type="text" name="nombre" value="${ tproblemas.nombre }"required>
