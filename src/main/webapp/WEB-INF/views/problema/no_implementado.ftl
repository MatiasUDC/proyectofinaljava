...
<html>
    ...
    <body>
        <div class="container">
            <h2><span>¡Vaya!</span>Servicio no implementado</h2>
            <p>
                ¡Vaya! Algo salió mal.<br/>>br/>
                Actualmente este servicio no esta disponible xD.
            </p>
            <@link_to class="btn btn-info"controller="home">Home</@link_to>
        </div>
    </body>
</html>